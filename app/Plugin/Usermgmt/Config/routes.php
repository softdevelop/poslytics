...
Router::connect('/createList', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'createList'));
Router::connect('/editUser/*', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'editUser'));
Router::connect('/editMyprofile/*', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'editMyprofile'));
