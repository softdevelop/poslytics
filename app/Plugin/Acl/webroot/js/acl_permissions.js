...
AclPermissions.documentReady = function() {
    ...
    $('.acl_permissions table tr:has(div.controller)').addClass('controller-row');
}
...
AclPermissions.permissionToggle = function() {
    ...
    $('img.permission-toggle').click(function() {
        ...
        // show loader
        $(this).attr('src', Vhung.basePath+'img/ajax/circle_ball.gif');

        // prepare loadUrl
        var loadUrl = Vhung.basePath+'admin/acl/acl_permissions/toggle/';
        loadUrl    += acoId+'/'+aroId+'/';
...
$(document).ready(function() {
    if (Vhung.params.controller == 'admin') {
