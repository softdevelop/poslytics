...
<div class="box-content">
    ...
    <table class="form">
        ...
        <tr>
            <td class="label">Category Albums </td>
            <td><?php echo $this->Form->input('albums_category_id',array('label'=>false)); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td> 
                <?php
                    if(isset($this->request->data['Album']['image']))
                        echo '<div class="img_news" onclick="openKCFinder_singleFile(this)">
                        <img src="'.$this->request->data['Album']['image'].'" id="img" style="visibility: visible;">
                        </div>';    
                    else
