...
<div class="box-content">
    <?php echo $this->Form->create('AlbumsCategory'); ?>
    <table class="form">
        <tr>
            <td class="label">Tên </td>
            <td><?php echo $this->Form->input('name',array('label'=>false,'class'=>'max')); ?>
                <span style="color: red;">Nhập 'home' cho albums Category hiển thị trang chủ</span>
            </td>
        </tr>
        <tr>
            <td class="label">Categories Parent </td>
            <td><?php echo $this->Form->input('parent_id',array('label'=>false,'type'=>'select','options'=>$parentAlbumsCategories,'empty'=>'--Là danh mục cha--')); ?></td>
        </tr>
        <tr>
            <td class="label">Image </td>
            <td> 
                <?php
                    if(isset($this->request->data['AlbumsCategory']['image']))
                        echo '<div class="img_news" onclick="openKCFinder_singleFile(this)">
                        <img src="'.$this->request->data['AlbumsCategory']['image'].'" id="img" style="visibility: visible;">
                        </div>';    
                    else
